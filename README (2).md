...
- **Repository (this branch):** https://github.com/Smiley1Go/GEE/tree/Exercise_2
- **Project webpage:** [Datasets.html](./Datasets.html) — embeds the Earth Engine App alongside dataset info tabs (Project Info, Landsat 9, Sentinel-2, MODIS)
- **GitHub Pages:** https://smiley1go.github.io/GEE/
...
- `Datasets.html` — project webpage embedding the published Earth Engine App, with tabbed panels for project info and per-sensor dataset details
